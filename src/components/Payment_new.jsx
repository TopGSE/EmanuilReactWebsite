    ...
    <div className="payment-page">
      <div className="payment-container">
        ...
        <div className="membership-info-card">
          <h2>{t("payment.membershipDetails")}</h2>
          <div className="membership-benefits">
            <ul>
              <li>✅ {t("payment.benefit1")}</li>
              <li>✅ {t("payment.benefit2")}</li>
              <li>✅ {t("payment.benefit3")}</li>
              <li>✅ {t("payment.benefit4")}</li>
            </ul>
          </div>
          ...
          <p className="recurring-note">{t("payment.recurringNote")}</p>
        </div>
